...
export default async function PocPage() {
  ...
  const provider =
    configuredProvider === "twilio" || configuredProvider === "meta-cloud-api" || configuredProvider === "infobip" || configuredProvider === "vonage" || configuredProvider === "whatchimp" || configuredProvider === "wali"
      ? configuredProvider
      : "mock";

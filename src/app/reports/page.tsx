...
export default async function ReportsPage() {
  const { navItems, givingTrend, countrySummaries, dataReadiness, campaigns } =
  ...
  return (
    <DashboardShell navItems={navItems}>
      <PageHeader
        eyebrow="Reports"
        title="Insights"
        description="Giving momentum, country portfolio, campaign readiness, and backend integration health for board and coordinator review."
      />
              ...
              >
                <div className="flex flex-1 items-end">
                  <div
                    ...
                    style={{
                      height: `${Math.max(
                        (item.amount.amountMinor / maxGiving) * 100,
                        12,
                      )}%`,
                    }}
                  />

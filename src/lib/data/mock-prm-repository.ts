...
const partners: PartnerRecord[] = [
  {
    ...
    fullName: "Ama Serwaa",
    momoPhoneNumber: "+233245550181",
    whatsappNumber: "+233245550181",
...
const contributions: ContributionRecord[] = [
  {
    ...
    campaignName: "Banjul",
    provider: "MoMo statement",
    providerReference: "MOMO-CSV-10501",
    status: "Succeeded",
  ...
  },
  {
    ...
    campaignName: "Banjul",
    provider: "MoMo statement",
    providerReference: "MOMO-CSV-10502",
    status: "Succeeded",
    reconciliationStatus: "Matched",
  ...
  },
  {
    ...
    provider: "Bank CSV",
    providerReference: "BANK-CSV-10503",
    status: "Succeeded",
    reconciliationStatus: "Matched",
    acknowledgementStatus: "Sent",
    attentionTier: "Active year covered",
  ...
  },
  {
    ...
    provider: "Remittance export",
    providerReference: "REMIT-CSV-10504",
    status: "Review",
...
const imports: PaymentImportBatch[] = [
  {
    id: "import_momo_statement_july_8",
    provider: "MoMo statement",
    fileName: "momo-statement-july-8.csv",
  ...
  {
    id: "import_remittance_july_8",
    provider: "Remittance export",
    fileName: "remittance-export-july-8.csv",
...
const providerStatuses: ProviderStatus[] = [
  ...
  {
    name: "Payment CSV import",
    providerKey: "csv-import",
    status: "Planned",
    detail:
      "The sole money intake (Decision 0007): staff upload a period's payment CSV; rows are matched to partners and ticked paid. No payment provider integration.",
  },
  {

...
- **Same name, different people (2026-09-26, Decision 0028)**: identity is name AND number; a row updates an existing partner only when both match it, otherwise it is a new partner. Supersedes Decision 0024's name-first matching.
